...
describe("delay", () => {
  ...
  it("resolves after the specified milliseconds", async () => {
    const { default: delay } = await import("@bexio-chrome-extension/chrome-extension/src/utils/delay");
    let done = false;
...
describe("trimAll", () => {
  ...
  it("removes all whitespace from a string with extra spaces", async () => {
    const { default: trimAll } = await import("@bexio-chrome-extension/chrome-extension/src/utils/trimAll");
...
describe("toggleDisplayLoader", () => {
  ...
  it("sets the loader display to flex when called with no argument (show defaults to true)", async () => {
    ...
    const { toggleDisplayLoader } = await import("@bexio-chrome-extension/chrome-extension/src/utils/loader");
  ...
  it("swapDisplayStyle sets display directly without transition", async () => {
    loadFixture("monitoring-edit");
    const { swapDisplayStyle } = await import("@bexio-chrome-extension/chrome-extension/src/utils/loader");
...
describe("pressEnter", () => {
  ...
  it("is a KeyboardEvent with key not set and keyCode 13", async () => {
    const { default: pressEnter } = await import("@bexio-chrome-extension/chrome-extension/src/utils/pressEnter");
